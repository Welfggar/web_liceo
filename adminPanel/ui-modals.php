...
<head>
    ...
    <title><?php echo $language["Modals"]; ?> | Dason - Admin & Dashboard Template</title>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-wrap gap-3">
                                    ...
                                    <div>
                                        ...
                                        <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#exampleModalLongScrollable">Long Scrollable Modal</button>

                                        <!-- Scrollable modal -->
                                        <div class="modal fade" id="exampleModalLongScrollable" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongScrollableTitle" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
